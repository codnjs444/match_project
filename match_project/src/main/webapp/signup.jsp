				...
				<div align="center">
					<form name="regFrm" method="post" action="managerSignupProc.jsp">
						<table cellpadding="5">
							...
							<tr>
								<td class="input-text required">
									<input class="user" name="company_address" id="address_company" size="45" placeholder="주소">
								</td>
							</tr>
							<tr>
								<td class="input-text required">
									<input class="user" id="detailAddress_company" placeholder="상세주소">
								</td>
							</tr>
							<tr>
								<td>
							...
							<tr>
								<td class="input-text2 required">
									<input class="company" name="manager_id" id="manager_id"  placeholder="아이디">
								</td>
								<td class="input-text2 required">
									<input class="company" type="password" name="manager_pwd" id="manager_pwd" placeholder="비밀번호">
								</td>
							<tr>
								<td class="input-text required">
