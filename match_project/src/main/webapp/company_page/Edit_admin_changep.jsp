...
%>
	...
	<%@ include file="menu/sub_top.jsp"%>
	<%@ include file="menu/side_menu.jsp"%>
	
		<div style="width: 1400px; margin-left: 420px;">
			<p class="text-secondary"> 비밀번호는 8~16자 숫자, 영어, 특수문자를 사용할 수 있습니다. </p>
			<form id="frm" name="frm" method="POST" action="manager_changePasswordProc.jsp">
		...
		<script>
			$(document).ready(function() {
		        ...
		        $("#frm").on("submit", function(e) {
		            var userPwdFromServer = "<%=mMgr.getManagerPassword(manager_id)%>";
