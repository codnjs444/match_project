...
@WebServlet("/MoveApplicationDownServlet")
public class MoveApplicationDownServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        boolean result = aMgr.updateApplicationDate(postingIdx, userId);
